...
module.exports = {
  ...
  execute(message, args) {
    const Embed = new MessageEmbed()
      ...
      .setColor(0x0087b1)
      .setDescription(
        "Welcome to **RoboLiam Paradise**! This server is is entirely based around Liam's bot, **RoboLiam**. The server is more or lesss just a place for Liam to test the bot, so there's not much here. However, if you want, this is the perfect place to test the bot, decide if you'd like it on your own server, report bugs, and make suggestions!"
      )
      .setImage(
